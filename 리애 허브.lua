...
local Window = Rayfield:CreateWindow({
   ...
   KeySettings = {
      Title = "Untitled",
      Subtitle = "Key System",
      Note = "키 만들기 귀찮", -- Use this to tell the user how to get a key
...
local mainTab = Window:CreateTab("Main(타워 테러하기 딱 좋은 스크)", nil) -- title, Image
...
local mainTab = Window:CreateTab("Main(그냥 스크 모음)", nil) -- title, Image
local mainSection = mainTab:CreateSection("Main")

local Button = mainTab:CreateButton({
   Name = "피쉬 스크",
   Callback = function()
loadstring(game:HttpGet("https://api.luarmor.net/files/v3/loaders/b0ecb46a38f40d74d04df1dbacb41e91.lua"))()
    end,
})
...
local Button = mainTab:CreateButton({
   Name = "grow a grden",
   Callback = function()
 loadstring(game:HttpGet("https://pastebin.com/raw/8jkVmLF2"))()


local mainTab = Window:CreateTab("Main(스크립트 모음집)", nil) -- title, Image
local mainSection = mainTab:CreateSection("Main")


local Button = mainTab:CreateButton({
   Name = "한사람 만 지목해서 날릴수 있는 스크립트",
   Callback = function()
...
local Button = mainTab:CreateButton({
   Name = "올킬 밴 이딴거 모아논 허브",
   Callback = function()
   loadstring(game:HttpGet('https://pastebin.com/DVgWvRR8 '))()
...
local Button = mainTab:CreateButton({
   Name = "검열안 먹히는 스크 파키스탄으로 언어 바꾸삼",
   Callback = function() 
   loadstring(game:HttpGet("https://raw.githubusercontent.com/AnnaRoblox/AnnaBypasser/refs/heads/main/AnnaBypasser.lua",true))()


local Button = mainTab:CreateButton({
   Name = "원하는 사람 날리기 스크립트",
   Callback = function() 
...
local Button = mainTab:CreateButton({
   Name = "죽은 위치에서 부활 스크립트",
   Callback = function() 
   local respawnPoint = game.Workspace.RespawnPoint -- 부활 지점으로 설정할 객체

game.Players.PlayerAdded:Connect(function(player)
    player.CharacterAdded:Connect(function(character)
        -- 플레이어의 캐릭터가 추가될 때마다 호출
